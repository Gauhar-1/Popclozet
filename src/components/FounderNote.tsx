...
const FounderNote = () => {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      const founderElements = document.querySelectorAll(".founder-anim");
      ...
      tl.fromTo(
        ...
        { y: 0, opacity: 1, duration: 0.8, stagger: 0.1, ease: "power3.out", clearProps: "willChange" }
      );
  ...
  return (
    <section
      ref={sectionRef}
      className="relative py-12 sm:py-16 md:py-20 lg:py-32 overflow-hidden bg-[#590d22] text-white"
    >
      ...
      <div ref={containerRef} className="container mx-auto px-4 md:px-6 max-w-6xl relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-10 md:gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-5 text-center lg:text-left founder-anim">
            <div className="inline-flex items-center gap-2 bg-white/10 border border-white/10 rounded-full px-3 sm:px-4 py-1.5 mb-4 sm:mb-6 backdrop-blur-sm">
              <PenTool className="w-3 h-3 text-pink-300" />
              <span className="text-[10px] sm:text-xs font-bold uppercase tracking-widest text-pink-100">From the Desk of</span>
            </div>
            
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-serif font-bold leading-tight mb-4 sm:mb-6">
              We Built This to <br />
          ...
          <div className="lg:col-span-7 founder-anim">
            <div className="relative bg-white text-[#1a1a1a] p-6 sm:p-8 md:p-10 lg:p-12 rounded-[1.5rem] sm:rounded-[2rem] md:rounded-tr-[3rem] lg:rounded-tr-[5rem] shadow-2xl border-4 border-pink-100/10">
              
              {/* Giant Quote Mark */}
              <div className="absolute -top-4 sm:-top-6 -left-3 sm:-left-4 bg-[#8B1A3D] text-white p-3 sm:p-4 rounded-xl sm:rounded-2xl shadow-lg transform -rotate-6">
              ...
              <div className="space-y-4 sm:space-y-6 relative z-10">
                <p className="text-lg sm:text-xl md:text-2xl font-serif leading-relaxed">
                  ...
                  <br className="mb-2 sm:mb-4 block"/>
                  <span 
                    ref={highlightRef}
